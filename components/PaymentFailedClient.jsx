        ...
        <div className="max-w-[1200px] mx-auto px-4 py-20 text-center">
            <div className="flex flex-col items-center max-w-2xl mx-auto">
                ...
                <p className="text-zinc-500 mb-2 max-w-md">
                    Your payment could not be processed. Don&apos;t worry — no money has
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full mb-12 text-left">
                    ...
                    <div className="p-6 border border-zinc-100 dark:border-zinc-800 rounded-3xl bg-zinc-50/50 dark:bg-zinc-900/30">
                        ...
                        <p className="text-sm text-zinc-500 leading-relaxed">
                            ...
                            . Contact us for faster resolution.
                        </p>
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
                    <Button
                        asChild
                        size="lg"
                        className="w-full sm:w-auto min-w-[220px] rounded-full h-14 bg-zinc-900 dark:bg-white text-white dark:text-black font-bold gap-2"
                    >
                        <Link href="/cart">
                            <RefreshCw size={18} />
                            Retry Payment
